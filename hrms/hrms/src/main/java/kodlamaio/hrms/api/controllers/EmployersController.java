...
public class EmployersController {
	...
	public Result register(@Valid @RequestBody RegisterModelForEmployerDto registerModelForEmployerDto) {
		return this.employerService.register(registerModelForEmployerDto);
	}
