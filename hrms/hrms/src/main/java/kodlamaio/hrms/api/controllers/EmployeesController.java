...
public class EmployeesController {
	...
	public Result register(@Valid @RequestBody RegisterModelForEmployeeDto registerModelForEmployeeDto) {
		return this.employeeService.register(registerModelForEmployeeDto);
	}
	
	@GetMapping("/getAllByIsActive")
	public DataResult<List<Employee>> getAllByIsActive(){
		return this.employeeService.getAllByIsActive();
	}
